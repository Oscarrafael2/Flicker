...
export const metadata = {
  title: "Películas de Terror - CineApp",
  description: "Las mejores películas de terror para los amantes del suspenso",
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-24 pb-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-foreground">Terror</h1>
              <p className="text-muted-foreground">Películas que te harán temblar</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-16">
        <div className="max-w-7xl mx-auto">
          <GenreMovieGrid movies={peliculasTerror} genre="terror" />
        </div>
      </section>
    </div>
  );
